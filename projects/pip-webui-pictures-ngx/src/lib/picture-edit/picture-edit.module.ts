...
@NgModule({
  declarations: [PipPictureEditComponent],
  imports: [CommonModule, MatButtonModule, MatIconModule, PipPictureModule, PipAddImageModule],
  exports: [PipPictureEditComponent],
  providers: [],
})
